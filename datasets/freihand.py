...
from tools.kinematics import MPIIHandJoints
from models.loss import contrastive_loss_3d, contrastive_loss_2d
import vctoolkit as vc
from build import DATA_REGISTRY
import matplotlib
matplotlib.use('TkAgg')  # Or 'Qt5Agg', depending on which GUI backend you have installed
